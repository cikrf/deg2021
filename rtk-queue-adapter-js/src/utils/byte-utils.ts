import { libs } from '@wavesenterprise/signature-generator'

export const encodeBase64 = (data: Uint8Array): string => `base64:${libs.base64.fromByteArray(data)}`

export const decodeBase64 = (data: string): Uint8Array => libs.base64.toByteArray(data.replace('base64:', ''))
